...
- [ ] **Phase 4 — Account & security hardening** (new — account deletion, email verification via Resend, opt-in phone/SMS MFA via Twilio Verify, new `settings.tsx` page; see plan doc's "Account & security hardening" section. Note: plan cancel/change is *not* new work — it already works via Phase 2's Stripe Billing Portal)
